...
Подробнее: [Create DAG documentation in Apache Airflow](https://www.astronomer.io/docs/learn/custom-airflow-ui-docs-tutorial), [DAG parameters](../astronomer-dags/dag-parameters.md).
