...
Технически через XCom можно передавать и большие объёмы, но делать это не рекомендуется без [кастомного XCom backend](../04.%20astronomer-advanced/custom-xcom-backends.md) и [масштабирования воркеров](../03.%20astronomer-infra/scaling-airflow.md).
