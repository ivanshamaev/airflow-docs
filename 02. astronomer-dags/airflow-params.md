...
Params хорошо подходят для хранения информации, специфичной для отдельных запусков DAG: изменяемые даты, пути к файлам или конфигурации ML-моделей. Params не шифруются и поэтому не подходят для передачи секретов. См. также [Рекомендации по хранению информации в Airflow](https://www.astronomer.io/docs/learn/airflow-variables#best-practices-for-storing-information-in-airflow).
