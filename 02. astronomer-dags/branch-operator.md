...
- [**BranchExternalPythonOperator**](https://registry.astronomer.io/providers/apache-airflow/versions/latest/modules/BranchExternalPythonOperator): ветвление по Python-функции, выполнение в уже существующем виртуальном окружении (как у [ExternalPythonOperator](https://www.astronomer.io/docs/learn/airflow-isolated-environments)).
