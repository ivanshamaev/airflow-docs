...
- **DAG с несколькими командами** — группы визуально разделяют задачи по командам. В таком случае иногда лучше разнести логику по разным DAG и связать их через [Assets](../01.%20astronomer-basic/assets.md).
