...
- [Pools](https://www.astronomer.io/docs/learn/airflow-pools).
- [XCom](https://www.astronomer.io/docs/learn/airflow-passing-data-between-tasks).
- [Connections](https://www.astronomer.io/docs/learn/connections).
...
- **Triggers** — все текущие [triggers](https://www.astronomer.io/docs/learn/deferrable-operators).
