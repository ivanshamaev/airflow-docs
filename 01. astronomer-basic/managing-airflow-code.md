...
> **Совет.** В зависимости от того, как вы запускаете Airflow, можно настроить несколько DAG bundle и подтягивать DAG из нескольких источников в одно окружение. Подробнее: [Версионирование DAG и DAG bundles](../02.%20astronomer-dags/dag-versioning.md).
